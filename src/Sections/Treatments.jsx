...
export default function TreatmentsSection({ onViewAll }) {
  ...
  //        if (entry.isIntersecting) { el.classList.add("treatments--visible"); observer.disconnect(); }
  //      }, { threshold: 0.1 });
  //      observer.observe(el);
  ...
  // REPLACED: useState(null) for activeCard + setActiveCard in onMouseEnter/Leave
  //           → direct classList toggle on each card DOM node
  //
  //  OLD:
  ...
  function onMouseEnter(e) {
    e.currentTarget.classList.add("t-card--active");
  }
  function onMouseLeave(e) {
    e.currentTarget.classList.remove("t-card--active");
  }
    ...
    >
      ...
      <div className="treatments__header">
        ...
        <h2 className="treatments__heading">
          Complete Care for{" "}
          <span className="treatments__heading-accent">Every Smile</span>
        </h2>
