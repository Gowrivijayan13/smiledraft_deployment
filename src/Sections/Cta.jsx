...
//  - useRef(bannerRef) + useEffect(IntersectionObserver)
//    → ref callback handleBannerRef
//  - observer.disconnect() cleanup stored on the element itself
//
// ════════════════════════════════════════════════════════════
...
// ─── Floating Stat Card ───────────────────────────────────────
const StatCard = ({ className, iconClass, label, value, sub }) => (
...
const Cta = () => {
  ...
  return (
    <section className="cta-section" id="cta">
      <div className="cta-banner" ref={handleBannerRef}>
